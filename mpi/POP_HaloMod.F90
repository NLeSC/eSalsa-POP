...
#ifdef JASON_PRINT_HALO
   print *, 'JASON: Create HALO on ', POP_myTask, ' of ', numProcs
#endif
...
#ifdef JASON_PRINT_HALO
   print *, 'JASON: blockSizeX ',  blockSizeX
   print *, 'JASON: blockSizeY ',  blockSizeY
   print *, 'JASON: eastMsgSize ',  eastMsgSize
   print *, 'JASON: westMsgSize ',  westMsgSize
   print *, 'JASON: southMsgSize ',  southMsgSize
   print *, 'JASON: northMsgSize ',  northMsgSize
   print *, 'JASON: cornerMsgSize ',  cornerMsgSize
   print *, 'JASON: tripoleMsgSize ',  tripoleMsgSize
   print *, 'JASON: tripoleMsgSizeOut ',  tripoleMsgSizeOut
#endif
...
#ifdef JASON_PRINT_HALO
   print *, 'JASON: halo%numLocalCopies ',  halo%numLocalCopies
#endif
...
#ifdef JASON_PRINT_HALO
   print *, 'JASON: halo%numMsgSend ', halo%numMsgSend
   print *, 'JASON: halo%numMsgRecv ', halo%numMsgRecv
#endif
...
!JASON:
!
! This is a BUG, as it does not take the MAX of the prev and current number of messages!
!
...
! Replaced by this:
      ...
      if (numMsgSend > size(bufSendR8,dim=2)) then
         resize = .true.
      else
         numMsgSend = size(bufSendR8,dim=2)
      endif

      if (numMsgRecv > size(bufRecvR8,dim=2)) then
         resize = .true.
      else
         numMsgRecv = size(bufRecvR8,dim=2)
      endif
...
#ifdef JASON_PRINT_HALO
   print *, 'JASON: allocate halo%sendTask', numMsgSend
   print *, 'JASON: allocate halo%recvTask', numMsgRecv
   print *, 'JASON: allocate halo%sizeSend', 3, bufSizeSend, numMsgSend
   print *, 'JASON: allocate halo%sizeRecv', 3, bufSizeRecv, numMsgRecv
   print *, 'JASON: allocate halo%srcLocalAddr', 3, halo%numLocalCopies
   print *, 'JASON: allocate halo%drcLocalAddr', 3, halo%numLocalCopies
#endif
...
#ifdef JASON_PRINT_HALO
   print *, 'JASON: result halo%communicator', halo%communicator
   print *, 'JASON: result halo%numMsgSend', halo%numMsgSend
   print *, 'JASON: result halo%numMsgRecv', halo%numMsgRecv
   print *, 'JASON: result halo%numLocalCopies', halo%numLocalCopies
   print *, 'JASON: result halo%recvTask', halo%recvTask
   print *, 'JASON: result halo%sendTask', halo%sendTask
   print *, 'JASON: result halo%sizeSend', halo%sizeSend
   print *, 'JASON: result halo%sizeRecv', halo%sizeRecv
   print *, 'JASON: result halo%srcLocalAddr', halo%srcLocalAddr
   print *, 'JASON: result halo%dstLocalAddr', halo%dstLocalAddr
   print *, 'JASON: result halo%sendAddr', halo%sendAddr
   print *, 'JASON: result halo%recvAddr', halo%recvAddr
#endif
