...
!-----------------------------------------------------------------------
   ...
   do n=1,POP_numBlocks
      ...
      if (srcTask /= 0 .and. srcIndex /= 0) then
...
#ifdef JASON_PRINT_REDIST
          write(*,*) 'JASON: redistributed block', n, 'from', srcTask, srcIndex, &
             'to', dstTask, dstIndex, 'on', POP_myTask
#endif
...
#ifdef JASON_PRINT_REDIST
             write(*,*) 'JASON: redistributed block using IRECV'
#endif
...
#ifdef JASON_PRINT_REDIST
             write(*,*) 'JASON: redistributed block using ISEND'
#endif
             numSends = numSends + 1
...
#ifdef JASON_PRINT_REDIST
             write(*,*) 'JASON: redistributed block using LOCAL'
#endif
...
#ifdef JASON_PRINT_REDIST
           write(*,*) 'JASON: redistributed block SKIPPED'
#endif
       endif
   end do
...
#ifdef JASON_PRINT_REDIST
   write(*,*) 'JASON: redistributed block dropping into WAITALL'
#endif
...
#ifdef JASON_PRINT_REDIST
   write(*,*) 'JASON: redistributed block DONE'
#endif
