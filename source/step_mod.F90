...
#ifdef JASON_TIMER
   integer (int_kind) :: &
      cycles1, cycles2,cycles3 ! temps to hold cycle info before correction
#endif
...
#ifdef JASON_TIMER
   call system_clock(count=cycles1)
   write(*,*) 'JASON step at global time: ', cycles1
   cycles3=cycles1
#endif
...
!-----------------------------------------------------------------------
   ...
   do ipass = 1,num_passes
      ...
      write(*,*) 'JASON matsuno loop: ', ipass, 1,num_passes, cycles2, (cycles2-cycles3)
      cycles3=cycles2
#endif
...
#ifdef JASON_TIMER
      call system_clock(count=cycles2)
      write(*,*) 'JASON start clinic ', cycles2, (cycles2-cycles3)
      cycles3 = cycles2
#endif
...
#ifdef JASON_TIMER
      call system_clock(count=cycles2)
      write(*,*) 'JASON done clinic start haloupdate', cycles2, (cycles2-cycles3)
      cycles3 = cycles2
#endif
...
#ifdef JASON_TIMER
      call system_clock(count=cycles2)
      write(*,*) 'JASON done haloupdate start tropic', cycles2, (cycles2-cycles3)
      cycles3 = cycles2
#endif
...
#ifdef JASON_TIMER
      call system_clock(count=cycles2)
      write(*,*) 'JASON done tropic start clinic adjust', cycles2, (cycles2-cycles3)
      cycles3 = cycles2
#endif
...
#ifdef JASON_TIMER
      call system_clock(count=cycles2)
      write(*,*) 'JASON done clinic adjust start 3D update', cycles2, (cycles2-cycles3)
      cycles3 = cycles2
#endif
...
#ifdef JASON_TIMER
      call system_clock(count=cycles2)
      write(*,*) 'JASON done 3D update start add', cycles2, (cycles2-cycles3)
      cycles3 = cycles2
#endif
...
#ifdef JASON_TIMER
      call system_clock(count=cycles2)
      write(*,*) 'JASON done add', cycles2, (cycles2-cycles3)
      cycles3 = cycles2
#endif
...
#ifdef JASON_TIMER
   call system_clock(count=cycles2)
   write(*,*) 'JASON matsuno loop done start extrapolate: ', cycles2, (cycles2-cycles3)
   cycles3=cycles2
#endif
...
#ifdef JASON_TIMER
   call system_clock(count=cycles2)
   write(*,*) 'JASON extrapolate done, start diag ', cycles2, (cycles2-cycles3)
   cycles3=cycles2
#endif
...
#ifdef JASON_TIMER
   call system_clock(count=cycles2)
   write(*,*) 'JASON diag done, start tavg: ', cycles2, (cycles2-cycles3)
   cycles3=cycles2
#endif
...
#ifdef JASON_TIMER
   call system_clock(count=cycles2)
   write(*,*) 'JASON tavg done, start diag: ', cycles2, (cycles2-cycles3)
   cycles3=cycles2
#endif
...
#ifdef JASON_TIMER
   call system_clock(count=cycles2)
   write(*,*) 'JASON step done: ', cycles2, (cycles2-cycles3), (cycles2-cycles1)
#endif
