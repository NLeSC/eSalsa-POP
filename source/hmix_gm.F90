...
! !REVISION HISTORY:
!  SVN:$Id: hmix_gm.F90 14536 2009-02-23 18:20:20Z njn01 $
...
!maltrud lazy do all of the errorCode checking later
!     call POP_ErrorSet(errorCode, &
!        'ERROR reading hmix_gm_nml')
!     return
...
! !INTERFACE:
      ...
      subroutine hdifft_gm (k, GTK, TMIX, UMIX, VMIX, this_block,errorCode)
