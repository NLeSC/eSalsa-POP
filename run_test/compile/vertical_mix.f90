...
!
! !REVISION HISTORY:
! SVN:$Id: vertical_mix.F90 9555 2008-04-17 19:30:26Z njn01 $
...
!-----------------------------------------------------------------------
   ...
   case(vmix_type_kpp)
!maltrud merge ccsm uses mixtime, lanl uses curtime for kpp
...
! \end{equation}
! \begin{eqnarray}
! \kappa\delta_z\varphi = Q_\varphi &{\rm at }& z=0 \! \kappa\delta_z\varphi = 0 &{\rm at }& z=-H_T
...
! \end{equation}
! \begin{eqnarray}
! \mu\delta_z(u,v) = (\tau_x,\tau_y) &{\rm at }& z=0 \! \mu\delta_z(u,v) = c|{\bf\rm u}|(u,v) &{\rm at }& z=-H_U
