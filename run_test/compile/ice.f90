...
!
! !REVISION HISTORY:
! SVN:$Id: ice.F90 17212 2009-07-20 23:01:42Z njn01 $
...
!maltrud allocate QICE, AQICE even for inactive ice since boundary
! updates are assumed to happen in step. include QFLUX just in case.
