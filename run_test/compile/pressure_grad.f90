...
! !USES:
   ...
   use POP_DomainSizeMod, only : POP_km, POP_maxBlocksClinic
...
! use io, only:
   ...
   use time_management, only: leapfrogts
...
!-----------------------------------------------------------------------
   ...
   real (r8), dimension(nx_block,ny_block,POP_maxBlocksClinic) :: &
...
! \delta_x \overline{\rho_m}^y \right] dz_{m-{1\over 2}} } \! \delta_y \overline{p_k}^x &=& \delta_y \overline{p_s}^x +
